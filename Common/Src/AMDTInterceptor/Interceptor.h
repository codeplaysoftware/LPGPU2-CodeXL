...
/// \param lpProcessInformation A pointer to a PROCESS_INFORMATION structure that
///        receives identification information about the new process
/// \param nDllCount The number of Dlls to inject
/// \param lpDllNames Full paths and names of the dlls to inject into the new
///        process, as an Array of pointers
/// \return non-zero if function succeeds, 0 if error
// ---------------------------------------------------------------------------
...
BOOL WINAPI CreateProcessAndInjectDllsW(_In_opt_ LPCWSTR lpApplicationName,
    ...
    #define CreateProcessAndInjectDlls      CreateProcessAndInjectDllsW
#else
    #define CreateProcessAndInjectDll       CreateProcessAndInjectDllA
    #define CreateProcessAndInjectDlls      CreateProcessAndInjectDllsA
#endif // !UNICODE
