...
//NOTE: Detours Express is not supported anymore, as it doesn't provide the multiple dll inject functions
//#define USE_DETOURS
...
BOOL WINAPI DLLInjector::CreateProcessAndInjectDllsA(_In_opt_ LPCSTR lpApplicationName,
                                                    _Inout_opt_ LPSTR lpCommandLine,
                                                    _In_opt_ LPSECURITY_ATTRIBUTES lpProcessAttributes,
                                                    _In_opt_ LPSECURITY_ATTRIBUTES lpThreadAttributes,
                                                    _In_ BOOL bInheritHandles,
                                                    ...
                                                    _Out_ LPPROCESS_INFORMATION lpProcessInformation,
                                                    _In_ int nDllCount,
                                                    _In_ LPCSTR* lpDllNames)
{
    return m_pImpl->CreateProcessAndInjectDllsA(lpApplicationName, lpCommandLine, lpProcessAttributes, lpThreadAttributes, bInheritHandles, dwCreationFlags,
                                               lpEnvironment, lpCurrentDirectory, lpStartupInfo, lpProcessInformation, nDllCount, lpDllNames);
}
...
BOOL WINAPI DLLInjector::CreateProcessAndInjectDllsW(_In_opt_ LPCWSTR lpApplicationName,
                                                    _Inout_opt_  LPWSTR lpCommandLine,
                                                    _In_opt_ LPSECURITY_ATTRIBUTES lpProcessAttributes,
                                                    _In_opt_ LPSECURITY_ATTRIBUTES lpThreadAttributes,
                                                    _In_ BOOL bInheritHandles,
                                                    ...
                                                    _In_ LPCSTR* lpDllNames)
{
    return m_pImpl->CreateProcessAndInjectDllsW(lpApplicationName, lpCommandLine, lpProcessAttributes, lpThreadAttributes, bInheritHandles, dwCreationFlags,
                                               lpEnvironment, lpCurrentDirectory, lpStartupInfo, lpProcessInformation, nDllCount, lpDllNames);
...
/// \return non-zero if function succeeds, 0 if error
// ---------------------------------------------------------------------------
BOOL WINAPI CreateProcessAndInjectDllsA(_In_opt_ LPCSTR lpApplicationName,
    _Inout_opt_ LPSTR lpCommandLine,
    _In_opt_ LPSECURITY_ATTRIBUTES lpProcessAttributes,
    _In_opt_ LPSECURITY_ATTRIBUTES lpThreadAttributes,
    _In_ BOOL bInheritHandles,
    ...
    _In_ LPCSTR* lpDllNames)
{
    return s_dllInjector.CreateProcessAndInjectDllsA(lpApplicationName, lpCommandLine, lpProcessAttributes, lpThreadAttributes, bInheritHandles, dwCreationFlags,
        lpEnvironment, lpCurrentDirectory, lpStartupInfo, lpProcessInformation, nDllCount, lpDllNames);
}
...
///        receives identification information about the new process
/// \param nDllCount The number of dlls to inject into the process
/// \param lpDllName Full paths and names of the dlls to inject into the new
///        process, as array
/// \return non-zero if function succeeds, 0 if error
// ---------------------------------------------------------------------------
BOOL WINAPI CreateProcessAndInjectDllsW(_In_opt_ LPCWSTR lpApplicationName,
                                       _Inout_opt_  LPWSTR lpCommandLine,
                                       _In_opt_ LPSECURITY_ATTRIBUTES lpProcessAttributes,
                                       _In_opt_ LPSECURITY_ATTRIBUTES lpThreadAttributes,
                                       _In_ BOOL bInheritHandles,
                                       ...
                                       _In_ LPCSTR* lpDllNames)
{
    return s_dllInjector.CreateProcessAndInjectDllsW(lpApplicationName, lpCommandLine, lpProcessAttributes, lpThreadAttributes, bInheritHandles, dwCreationFlags,
                                                    lpEnvironment, lpCurrentDirectory, lpStartupInfo, lpProcessInformation, nDllCount, lpDllNames);
}
