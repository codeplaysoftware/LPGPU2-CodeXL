...
///       native to CodeXL. In this windows version, we simply call the original
///       function since on windows this does not leak file descriptors.
...
OS_API bool LPGPU2osExecAndGrabOutput(const char* cmd, const bool& cancelSignal, gtString& cmdOutput)
{
  return osExecAndGrabOutput(cmd, cancelSignal, cmdOutput);
}
// --AT:LPGPU2
