...
public:
    ...
    osFilePath(osPreDefinedFilePaths predefinedfilePath, const gtString& fileName, const gtString& fileExtension, bool convertToLower = false);
//++AT:LPGPU2
    osFilePath(osApplicationSpecialDirectories predefinedfilePath,
        const gtString& fileName, const gtString& fileExtension,
        bool applyRedirection = false);
//--AT:LPGPU2
