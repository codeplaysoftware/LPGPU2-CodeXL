...
#define OS_MAX_PATH 260
    ...
    //++TLRS: LPGPU2: Adding SYCL module names
    #if AMDT_BUILD_CONFIGURATION == AMDT_DEBUG_BUILD
        #define OS_SYCL_ICD_MODULE_NAME L"ComputeCpp_vs2015_d.dll"
    #else
        #define OS_SYCL_ICD_MODULE_NAME L"ComputeCpp_vs2015.dll"
    #endif
    //--TLRS: LPGPU2: Adding SYCL module names
    ...
    #define OS_SPIES_SUB_DIR_NAME L"spies"
        ...
        //++TLRS: LPGPU2: Adding SYCL module names
        #define OS_SYCL_ICD_MODULE_NAME L"libComputeCpp.so"
        //--TLRS: LPGPU2: Adding SYCL module names
