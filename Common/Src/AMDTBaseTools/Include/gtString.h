...
private:
    ...
    // Guard fence for investigation _stringAsASCIICharArray misbehaviour 
    // overflow. Be sure to total clean VStudion solution and rebuild as
    // gtString may not get pull into ALL DLL build after altering this
    // class
    unsigned long _a;
    unsigned long _b;
    ...
    // Guard fence for investigation wstring misbehaviour
    unsigned long _c;
    unsigned long _d;
};
