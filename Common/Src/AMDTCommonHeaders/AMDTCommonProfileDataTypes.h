...
//++CF:LPGPU2 change sample time from int to gtUInt64
    SampledValue(gtUInt64 sampleTime, double sampleValue) :
//--CF:LPGPU2
...
//++CF:LPGPU2 update to gtuin64
struct SamplingTimeRange
{
//++AT:LPGPU2
    SamplingTimeRange(gtInt64 fromQuantizedTime, gtInt64 toQuantizedTime) :
