...
//++AT:LPGPU2
    void setAndroidRemoteDebugging() { m_isAndroidDeviceTarget = true; m_isRemoteTarget = false; };
//--AT:LPGPU2
...
//++AT:LPGPU2
    bool isAndroidDeviceTarget() const { return m_isAndroidDeviceTarget; };
//--AT:LPGPU2
...
//++IOR: LPGPU2 Code SYCL implementation runtime location
    void            SetSYCLRuntimeLib(const gtString& runtimeName);
    const gtString  GetSYCLRuntimeLibName() const;
    void            SetFlagSYCLRuntimeLibInUse(bool vbInUse);
    bool            GetFlagSYCLRuntimeLibInUse() const;
//--IOR: LPGPU2 Code SYCL implementation runtime location
...
//++AT:LPGPU
    // Is the project targeting a remote Android device?
    bool m_isAndroidDeviceTarget;
//--AT:LPGPU2
...
//++IOR: LPGPU2 Code SYCL implementation runtime location
    /// The SYCL Runtime library used to profile SYCL applications
    gtString m_SYCLRuntimeLibName;
    
    /// Flag indicating is the SYCL runtime library is in use
    /// True = yes, false = no
    bool m_bSYCLRuntimeLibInUse;
//--IOR: LPGPU2 Code SYCL implementation runtime location
};
