...
//++IOR: LPGPU2 Code Coverage Analysis
    { AC_ICON_CCVG_MODE, 0, 36 },
    { AC_ICON_CCVG_APPTREEROOTNODE_SETFILESGOOD, 1, 36 },
    { AC_ICON_CCVG_APPTREEROOTNODE_SETFILESBAD, 2, 36 },
    { AC_ICON_CCVG_APPTREECCVGITEM, 3, 36 },
    { AC_ICON_CCVG_APPTREECCVGITEM_RESULTS, 4, 36 },
    { AC_ICON_CCVG_APPTREECCVGITEM_SOURCE, 5, 36 },
    { AC_ICON_CCVG_APPTREECCVGITEM_DRIVERS, 6, 36 },
    { AC_ICON_CCVG_APPTREECCVGITEM_EXECUTEABLE, 7, 36 },
    { AC_ICON_CCVG_APPTREECCVGITEM_BAD, 8, 36 },
    { AC_ICON_CCVG_APPTREECCVGITEM_RESULTS_BAD, 9, 36 },
    { AC_ICON_CCVG_APPTREECCVGITEM_SOURCE_BAD, 10, 36 },
    { AC_ICON_CCVG_APPTREECCVGITEM_DRIVERS_BAD, 11, 36 },
    { AC_ICON_CCVG_APPTREECCVGITEM_EXECUTEABLE_BAD, 12, 36 },
      //-------------------------------------------------//
//--IOR: LPGPU2 Code Coverage Analysis
