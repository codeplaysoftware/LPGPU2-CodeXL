...
// Globals
// Timeout default
AMDT_REMOTE_CLIENT_API extern const gtUInt64 kTCPTimeoutDefault;
//--AT:LPGPU2
...
//++AT:LPGPU2
    bool TerminateWholeSession(bool isAndroid = false);
//--AT:LPGPU2
...
//++AT:LPGPU2
    ...
    bool LPGPU2_WriteChunk(RemProtoToken chunkID, const gtByte *payload = nullptr, gtUInt32 payloadSize = 0);
    bool LPGPU2_DisconnectFromAndroidDevice();
    bool LPGPU2_GetAndroidRemoteAgentInfo(const gtString& localTargetFileName);
    bool LPGPU2_ReceiveCollectedAndroidChunks(std::vector<gtByte> &chunk);
    bool IsConnected() const;
    bool LPGPU2_ReceiveHeader(ChunkHeader &header);
...
//--AT:LPGPU2
    ...
    // returns true if HSA enabled on remote machine
    bool IsHSAEnabled();
