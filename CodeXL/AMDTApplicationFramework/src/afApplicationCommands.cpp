...
//++AT:LPGPU2
// Commenting this out because it results in unwanted behaviour when:
// - A project is already open
// - The new project window is opened
// - A new project is setup
// - OK is clicked
// This results in the OnFileCloseProject calling the
// RestoreDefaultProjectSettings of the extensions, effectively making you lose
// the changes you made when creating the new project stated above.
...
//++IOR: LPGPU2 Notify extensions the project is closed
    afCloseProjectCommand closeProjectCmd;
      const bool rc = closeProjectCmd.execute();
      GT_ASSERT(rc);
//--IOR: LPGPU2 Notify extensions the project is closed
}
