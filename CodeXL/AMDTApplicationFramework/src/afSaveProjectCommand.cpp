...
//++CF:LPGPU2
            // Set the SYCL Runtime (used only to profile SYCL applications)
            rc = rc && setDebuggedApplicationData(docHandle, fieldName.fromASCIIString(AF_STR_loadProjectSYCLRuntimePathNode), m_pProjectSettings->GetSYCLRuntimeLibName());
//--CF:LPGPU2
            // Set daemon configurations.
            rc = true;
            gtString isRemoteSession = m_pProjectSettings->isRemoteTarget() ? L"yes" : L"no";
//++AT:LPGPU2
            gtString isAndroidSession = m_pProjectSettings->isAndroidDeviceTarget() ? L"yes" : L"no";
//--AT:LPGPU2
...
//++AT:LPGPU2
            rc = rc && setDebuggedApplicationData(docHandle, fieldName.fromASCIIString(AF_LPGPU2_STR_loadProjectIsAndroidDeviceSession), isAndroidSession);
//--AT:LPGPU2
...
//++CF:LPGPU2
    		"<" AF_STR_loadProjectSYCLRuntimePathNode">" OS_STR_EmptyXMLString"</" AF_STR_loadProjectSYCLRuntimePathNode">\n"
//--CF:LPGPU2
        ...
        "<" AF_LPGPU2_STR_loadProjectIsAndroidDeviceSession">" OS_STR_EmptyXMLString"</" AF_LPGPU2_STR_loadProjectIsAndroidDeviceSession">\n"
