...
// ---------------------------------------------------------------------------
// Name:        afViewCreatorAbstract::ClrCreationEvent
// Description: Overrideable. Clear and delete the previous assigned event 
//              object.
// Author:      Illya Rudkin
// Date:        Mar-26, 2017
// ---------------------------------------------------------------------------
void afViewCreatorAbstract::ClrCreationEvent()
{
  if (_pCreationEvent != nullptr)
  {
    delete _pCreationEvent;
    _pCreationEvent = nullptr;
  }
}
