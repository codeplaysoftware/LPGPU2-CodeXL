...
void afApplicationTree::updateTreeRootText()
{
    ...
    const QString rootString = getTreeRootItemLabelText();
...
/// ---------------------------------------------------------------------------
/// \brief Name:        Retrieve the new tree root text for the tree item label
/// Format of the root string:
///                     ProjectName | Debug Mode (Running)
/// \return QString
/// ---------------------------------------------------------------------------
QString afApplicationTree::getTreeRootItemLabelText() const
{
  QString rootString;
  ...
  QString executionStatusString;
  QString executionModeString;
  ...
  {
    QString modeString = acGTStringToQString(pActiveMode->modeNameDisplayInGui());
