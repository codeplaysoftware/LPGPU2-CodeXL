...
public:
    ...
    void SaveProfileExtnParamProfileSessionType(const gtString& sessionType);
...
//++AT:LPGPU2
    void AdjustGUIToLPGPU2HostChange(bool isLPGPU2RadioBtnSelected);
    void NotifyExtensionsOfHostTypeChange(lpgpu2::HostType hostType);
//--AT:LPGPU2
...
//++AT:LPGPU2
    ...
    QRadioButton* m_pAndroidDeviceRadioButton;
#endif
//--AT:LPGPU2
