...
//++IOR: LPGPU2 Code Coverage Analysis
    AF_TREE_ITEM_CCVG_ROOTNODE_SETFILESGOOD,
    AF_TREE_FIRST_CCVG_ITEM_TYPE = AF_TREE_ITEM_CCVG_ROOTNODE_SETFILESGOOD,
    AF_TREE_ITEM_CCVG_ROOTNODE_SETFILESBAD,
    AF_TREE_ITEM_CCVG_CCVGITEM,
    AF_TREE_ITEM_CCVG_CCVGITEM_RESULTS,
    AF_TREE_ITEM_CCVG_CCVGITEM_SOURCE,
    AF_TREE_ITEM_CCVG_CCVGITEM_DRIVERS,
    AF_TREE_ITEM_CCVG_CCVGITEM_EXECUTEABLE,
    AF_TREE_ITEM_CCVG_CCVGITEM_BAD,
    AF_TREE_ITEM_CCVG_CCVGITEM_RESULTS_BAD,
    AF_TREE_ITEM_CCVG_CCVGITEM_SOURCE_BAD,
    AF_TREE_ITEM_CCVG_CCVGITEM_DRIVERS_BAD,
    AF_TREE_ITEM_CCVG_CCVGITEM_EXECUTEABLE_BAD,
    AF_TREE_LAST_CCVG_ITEM_TYPE = AF_TREE_ITEM_CCVG_CCVGITEM_DRIVERS,
//--IOR: LPGPU2 Code Coverage Analysis
    ...
    //++TLRS: LPGPU2: Adding new types of items for Power Profiling
    AF_TREE_ITEM_PP_SOURCES,
    AF_TREE_ITEM_PP_FEEDBACK,
    AF_TREE_ITEM_PP_COMPARE,
    //--TLRS: LPGPU2: Adding new types of items for Power Profiling
