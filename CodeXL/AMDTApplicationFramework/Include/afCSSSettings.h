...
//++AT:LPGPU2
#define AF_STR_captionLabelStyleSheetSecondaryBold "background-color:#F5F5F5; text-align:left; height:25px; padding-top: 3px; padding-bottom: 3px; font-weight:bold;"
#define AF_STR_captionLabelStyleSheetSecondary "background-color:#F5F5F5; text-align:left; height:25px; padding-top: 3px; padding-bottom: 3px;"
#define AF_STR_textLabelStyleSheetBold "text-align:left; height:25px; padding-top: 3px; padding-bottom: 3px; font-weight:bold;"
//--AT:LPGPU2
