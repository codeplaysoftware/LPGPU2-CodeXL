...
#define PM_STR_ErrorSYCLLibFilePathNotExistOrInvalid L"The SYCL runtime library name or path does not exist or is invalid"
#define PM_STR_ErrorSYCLLibFilePathPointsToExecutable L"The SYCL runtime library file path points to executeable type file which is not valid"
#define PM_STR_ErrorSYCLAPITraceOptionChosenSYCLLibFilePathNotValid L"SYCL API tracing has been enabled. Require a SYCL runtime library file path."
//--IOR: LPGPU2 Code SYCL implementation runtime location
...
//++IOR: LPGPU2 Code SYCL implementation runtime location
#define PM_STR_sharedProfileSettingsSYCLSectionCaption "SYCL"
#define PM_STR_sharedProfileSettingsSYCLRunTimeLocation "SYCL runtime library:"
#define PM_STR_sharedProfileSettingsSYCLRunTimeLocationTooltip "Enter the file path to the SYCL runtime library you wish to use"
#define PM_STR_sharedProfilerSettingsSYCLRuntimeLocationDlgTitle "Select the SYCL runtime library the project uses"
#define PM_STR_sharedProfilerSettingsSYCLRuntimeLocationBrowseForLibTooltip "Click to browse for a library path"
...
#define PM_STR_SYCLRUNTIMELIBRARYFILEPATH "SYCLRuntimeLibFilePath"

// Profile extension error
#define PM_STR_sharedProfilerSettingInternalErrorNotFindOpenCLTraceSettingsObj L"Internal error: Shared profiling cannot locate OpenCLTraceSetting object";
//--IOR: LPGPU2 Code SYCL implementation runtime location
