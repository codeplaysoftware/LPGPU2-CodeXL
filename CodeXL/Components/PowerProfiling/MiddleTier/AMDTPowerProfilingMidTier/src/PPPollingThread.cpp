...
PPPollingThread::PPPollingThread(unsigned pollingInterval, PPSamplesDataHandler cb, void* pDataCbParams, PPFatalErrorHandler cbErr, void* pErrorCbParams, IPowerProfilerBackendAdapter* pBeAdapter, amdtProfileDbAdapter* pDataAdapter, bool isJoinable)
    : osThread(L"PowerProfilingPollingThread", false, isJoinable)
