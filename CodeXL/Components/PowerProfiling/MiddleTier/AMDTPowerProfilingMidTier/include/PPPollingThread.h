...
public:
    ...
    PPPollingThread(unsigned pollingInterval, PPSamplesDataHandler cb, void* pDataCbParams, PPFatalErrorHandler cbErr, void* pErrorCbParams,
                    IPowerProfilerBackendAdapter* pBeAdapter, amdtProfileDbAdapter* pDataAdapter, bool isJoinable = false);
//++AT:LPGPU2
    virtual ~PPPollingThread();

    virtual int entryPoint() override;
    virtual unsigned GetCurrentQuantizedTime() const { return m_quantizedTime; }
