...
//++AT:LPGPU2
    static AMDTPwrCounterDesc* ConvertToPwrCounterDesc(gtUInt32 deviceId,
        const lpgpu2::CounterElement &element);
    static AMDTPwrUnit ConvertToPwrUnit(const gtString &units,
        const gtString &type);
    static AMDTPwrCategory ConvertToPwrCategory(const gtString &units);
//--AT:LPGPU2
};
