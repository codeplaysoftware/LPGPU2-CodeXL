...
//++AT:LPGPU2
    PowerProfilerCoreInitDetails() : m_isRemoteProfiling(false), m_isAndroidProfiling(false) {}
    ...
    PowerProfilerCoreInitDetails(const gtString& remoteHostAddr,
        ...
        m_isAndroidProfiling(false), m_remoteHostAddr(remoteHostAddr), m_remotePortNumber(remotePortAddr) {}
//--AT:LPGPU2
...
//++AT:LPGPU2
    // Is it android profiling
    bool m_isAndroidProfiling;

    // The collection definitions, if the profiling is of type android
    CollectionDefs m_collectionDefs;

    // The target characteristics, if the profiling is of type android
    TargetCharacteristics m_targetCharacteristics;

    // The target definitions, if the profiling is of type android
