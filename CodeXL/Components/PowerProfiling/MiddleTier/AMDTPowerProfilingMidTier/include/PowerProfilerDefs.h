...
{
//++AT:LPGPU2
    PPSampledValuesBatch() : m_quantizedTime(0U), m_sampleValues() {}
    PPSampledValuesBatch(gtUInt64 quantizedTime) :
      m_quantizedTime(quantizedTime), m_sampleValues() {}
//--AT:LPGPU2
    ~PPSampledValuesBatch() {}

    // The time when this batch of samples was taken.
//++AT:LPGPU2
    gtUInt64 m_quantizedTime;
//--AT:LPGPU2
...
//++AT:LPGPU2
using PPSamplesDataHandlerFunc = std::function<void(std::shared_ptr<const gtMap<int, PPSampledValuesBatch>> pSampledDataPerCounter, void* pParams)>;
//--AT:LPGPU2
