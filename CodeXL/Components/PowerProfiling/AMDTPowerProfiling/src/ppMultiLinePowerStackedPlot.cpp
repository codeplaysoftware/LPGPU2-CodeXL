...
// counter they track.
                                ...
                                int index = GetGraphIndexById(id);
//--AT:LPGPU2
...
//++AT:LPGPU2
                    graphItem = new acMultiLinePlotItemData(keyVec, valueVec, color, name, description, idAsStr, shouldDisableGraph);
//--AT:LPGPU2
                    graphData << graphItem;
                }
            }
...
//++AT:LPGPU2
                    idAsStr.setNum(m_relevantCountersVec[i]);
//--AT:LPGPU2
                }
...
//++AT:LPGPU2
                auto *graphItem = new acMultiLinePlotItemData(keyVec, valueVec,
                    color, name, description, idAsStr, shouldDisableGraph);
//--AT:LPGPU2
                graphData << graphItem;
            }
