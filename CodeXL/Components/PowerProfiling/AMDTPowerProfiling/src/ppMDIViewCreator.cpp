...
bool ppMDIViewCreator::createViewContent(int viewIndex, QWidget*& pContentQWidget, QWidget* pQParent)
{
    ...
    GT_IF_WITH_ASSERT(nullptr != pCurrentEvent)
    {
        ...
        //++TLRS: LPGPU2: Display the correct view upon creation
        int viewIndex1 = 0;
        switch (itemType)
        {
            ...
            case AF_TREE_ITEM_PP_SOURCES:
            viewIndex1 = 2;
            break;

            case AF_TREE_ITEM_PP_FEEDBACK:
            viewIndex1 = 3;
            break;

            case AF_TREE_ITEM_PP_COMPARE:
            viewIndex1 = 4;
            break;
...
bool ppMDIViewCreator::displayExistingView(const apMDIViewCreateEvent& mdiViewEvent)
{
    ...
    GT_IF_WITH_ASSERT(pCurrentEvent)
    {
        ...
        if (retVal)
        {
            //++TLRS: LPGPU2: Adding more tabs to the power profiling session view
