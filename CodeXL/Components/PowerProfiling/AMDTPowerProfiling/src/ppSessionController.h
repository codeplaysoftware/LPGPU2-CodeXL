...
//++CF:LPGPU2
    void GetSessionTimeRangeNanoSec(SamplingTimeRange& samplingTimeRange);
//--CF:LPGPU2
...
//++AT:LPGPU2
    void GetEnabledCountersByTypeAndCategoryAndDeviceId(
...
//++AT:LPGPU2
    const gtVector<PPDevice> GetSystemDevicesAsFlatVector();
//--AT:LPGPU2
