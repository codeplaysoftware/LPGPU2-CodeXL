...
//--AT:LPGPU2
    ...
    //++TLRS: LPGPU2: Allows overriding this methods so this class can be extended
    ...
    virtual bool CreateProfilingDatabase(const gtString& dbName, gtUInt64 profileType);
    ...
    virtual bool OpenProfilingDatabase(const gtString& dbName, gtUInt64 profileType, bool isReadOnly = true);
    ...
    bool GetCounterIdByName(const std::string& counterName, int& counterId) const;
...
protected:
    sqlite3* GetDatabaseWriteConnection() const;
    sqlite3* GetDatabaseReadConnection() const;
    //--TLRS: LPGPU2: The child classes need access to the sqlite connection
