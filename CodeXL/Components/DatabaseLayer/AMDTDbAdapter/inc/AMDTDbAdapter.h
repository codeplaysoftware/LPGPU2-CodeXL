...
{
public:    
    //++TLRS: LPGPU2: Allows subclasses to use their own accessor for the database access
    explicit AmdtDatabaseAdapter();
...
//++AT:LPGPU2
    virtual bool InsertSessionInfoKeyValue(const gtString& key, const gtString& value);
//--AT:LPGPU2
