...
//++IOR: LPGPU2 Notify extensions the project is closed
    ...
    virtual bool CloseCurrentProject() { return true; }
//--IOR: LPGPU2 Notify extensions the project is closed
    ...
    /// @return APITraceOptions Reference tothe settings object.
    const APITraceOptions& GetTraceOptions() const;
...
//++CF:LPGPU2
    QRadioButton*              m_pSYCLRadioButton;                ///< Radiobutton for SYCL applications
//--CF:LPGPU2
...
//++CF:LPGPU2
    QLabel*                    m_pSyclCaption;
    QLabel*                    m_pSYCLRuntimeLibTitle;
    QLineEdit*                 m_pSYCLRuntimeLibTextEdit;
    QToolButton*               m_pSYCLRuntimeLibPathButton;
    afBrowseAction*            m_pBrowseForSYCLLibButtonAction;
//--CF:LPGPU2
...
//++CF:LPGPU2
    void OnClickBrowseForSYCLLib();
    void SetSYCLSettingsControlsEnabled(const bool vbEnabled);
//--CF:LPGPU2
};
