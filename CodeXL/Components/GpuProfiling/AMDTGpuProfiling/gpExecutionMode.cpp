...
// ---------------------------------------------------------------------------
// Name:        gdExecutionMode::modeNameDisplayInTheGui
// Description: Mode name as shown in the CodeXL GUI
// Author:      Illya Rudkin
// Date:        09/2/2017
// ---------------------------------------------------------------------------
gtString gpExecutionMode::modeNameDisplayInGui()
{
  return modeName();
}
...
//++AT:LPGPU2
        CXL_DAEMON_CLIENT->TerminateWholeSession(
          afProjectManager::instance().currentProjectSettings().isAndroidDeviceTarget());
//--AT:LPGPU2
    }
