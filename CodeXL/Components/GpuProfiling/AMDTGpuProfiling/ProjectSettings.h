...
enum APIToTrace
{
    ...
    APIToTrace_SYCL = 0x4,                               ///< value indicating that SYCL APIs should be traced
    APIToTrace_ALL = APIToTrace_OPENCL | APIToTrace_HSA | APIToTrace_SYCL ///< value indicating that all APIs should be traced
};
...
//++CF:LPGPU2 (all these properties are public..?)
