...
//++CF:LPGPU2
#define GP_Str_AppTraceNoHSA_W                  L"HSA was selected but it is not available";
#define GP_Str_AppTraceNoSYCL_W                 L"SYCL was selected but it is not available";
#define GP_Str_ProjectSettingsSYCLAPI           "SYCL"
//--CF:LPGPU2
...
//++CF:LPGPU2
#define GP_Str_ProjectSettingsSYCLAPITooltip    "Profile applications that use SYCL"
//--CF:LPGPU2
...
//++CF:LPGPU2
#define GP_Str_ProjectSettingsSYCLTraceOptions  "SYCL Trace Options"
#define GP_Str_SYCLRuntimeLibPathCaption        "SYCL Runtime Library:"
#define GP_Str_SYCLBrowseActionID               "sycl"
#define GP_Str_SYCLRuntimeLibPathTooltip        "Click to select which SYCL runtime library the application relies on"
//--CF:LPGPU2
...
#define GPU_STR_ProjectSettingsAPITypeSYCL L"SYCL"
//++CF:LPGPU2
#define GPU_STR_ProjectSettingsSYCLRuntimePath L"SYCLRuntimePath"
//--CF:LPGPU2
...
//++CF:LPGPU2
#define GPU_STR_timeline_SYCLBranchName "SYCL"
#define GPU_STR_timeline_KernelBranchName "Kernel Execution"
#define GPU_STR_timeline_DataTransferBranchName "Data Transfer"
#define GPU_STR_timeline_CmdGroupBranchName "Command Groups"
#define GPU_STR_timeline_CmdGroupDetailBranchName "Command Group Detail"
