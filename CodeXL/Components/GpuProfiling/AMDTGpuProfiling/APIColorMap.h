...
public:
    ...
    /// Gets the color for the SYCL transaction/command group with the specified index
    /// \return the color for the transaction
    QColor GetSYCLTransactionColor(unsigned int tid) const;

    /// Get the default color for SYCL items
    /// \return the default color for SYCL items
    QColor GetSYCLDefaultColor() const;
