...
void InitAvailablePluginInfo()
{
    ...
    piCLTrace.shouldForceLoad = true;
    
    PluginInfo piICDLoader;
    piICDLoader.strPluginPath = g_strDLLPath + CL_ICD_LOADER_DLL;
    piICDLoader.strPluginName = "OpenCL LPGPU2 ICD loader";
    piICDLoader.shouldForceLoad = true;
    ...
    g_sPluginList.push_back(piICDLoader);
