...
public:
    ...
    cl_int Create(KHRpfn_clEnqueueFillBuffer next,
                  cl_command_queue command_queue,
                  cl_mem           buffer,
                  const void*      pattern,
                  size_t           pattern_size,
...
public:
    ...
    cl_int Create(KHRpfn_clEnqueueFillImage next,
                  cl_command_queue command_queue,
                  cl_mem           image,
...
public:
    ...
    cl_int Create(KHRpfn_clEnqueueMigrateMemObjects next,
                  cl_command_queue       command_queue,
                  cl_uint                num_mem_objects,
                  const cl_mem*          mem_objects,
...
public:
    ...
    /// \param event_wait_list Parameter for CLAPI_clEnqueueFillImage
    /// \param event Parameter for CLAPI_clEnqueueFillImage
    cl_int Create(KHRpfn_clEnqueueMarkerWithWaitList next,
                  cl_command_queue command_queue,
                  cl_uint          num_events_in_wait_list,
                  const cl_event*  event_wait_list,
                  cl_event*        event);
...
public:
    ...
    cl_int Create(KHRpfn_clEnqueueBarrierWithWaitList next,
                  cl_command_queue command_queue,
                  cl_uint          num_events_in_wait_list,
                  const cl_event*  event_wait_list,
                  cl_event*        event);
...
public:
    ...
    cl_int Create(KHRpfn_clEnqueueSVMFree next,
                  cl_command_queue command_queue,
...
public:
    ...
    cl_int Create(KHRpfn_clEnqueueSVMMemcpy next,
                  cl_command_queue command_queue,
...
public:
    ...
    cl_int Create(KHRpfn_clEnqueueSVMMemFill next,
                  cl_command_queue command_queue,
                  void*            svm_ptr,
                  const void*      pattern,
                  size_t           pattern_size,
...
public:
    ...
    cl_int Create(KHRpfn_clEnqueueSVMMap next,
                  cl_command_queue command_queue,
                  cl_bool          blocking_map,
                  cl_map_flags     flags,
                  void*            svm_ptr,
...
public:
    ...
    cl_int Create(KHRpfn_clEnqueueSVMUnmap next,
                  cl_command_queue command_queue,
                  void*            svm_ptr,
                  cl_uint          num_events_in_wait_list,
                  const cl_event*  event_wait_list,
...
#ifdef _WIN32
#define EVENT_CALL_CONVENTION __stdcall
#else
#define EVENT_CALL_CONVENTION
#endif
