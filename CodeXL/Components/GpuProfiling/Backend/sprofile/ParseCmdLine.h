...
typedef struct
{
    ...
    //++TLRS: LPGPU2: Adding a string to read the SYCL runtime library path
    std::string  strSYCLRuntimeLib;       ///< the SYCL runtime library path
    //--TLRS: LPGPU2: Adding a string to read the SYCL runtime library path
    ...
    bool         bSYCLTrace;              ///< flag indicating whether or not SYCL trace is enabled
