...
#++KB: LPGPU2
armv7a:
	$(MAKE) -f $(MAKEFILENAME) $(BUILD_ARMV7A_OVERRIDES)

Dbgarmv7a:
	$(MAKE) -f $(MAKEFILENAME) $(BUILD_DEBUG_ARMV7A_OVERRIDES)
#--KB: LPGPU2

#++AT:LPGPU2
aarch64:
	$(MAKE) -f $(MAKEFILENAME) $(BUILD_AARCH64_OVERRIDES)

Dbgaarch64:
	$(MAKE) -f $(MAKEFILENAME) $(BUILD_DEBUG_AARCH64_OVERRIDES)
#--AT:LPGPU2
...
$(OBJ_DIR)/%.o: $(BACKEND_SYCLPROFILEAGENT_DIR)/%.cpp
	$(BUILD_SRC)
