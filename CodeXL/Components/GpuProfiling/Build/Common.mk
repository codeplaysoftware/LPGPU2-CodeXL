...
TARGET_SUFFIX =
ADDL_CFLAGS =
# TODO(Kavan): You removed -msse option after -Werror
CFLAGS = $(OPTIMIZE) -std=c++11 -fPIC -Wall -Wno-unknown-pragmas -Wno-strict-aliasing -Wno-non-virtual-dtor -Wno-conversion-null -Werror $(PLATFORM_CFLAG) $(ADDL_CFLAGS)
HSAFDN_CFLAGS =
PLATFORM_DIR = x64
...
COMPUTECPP_DIR = $(COMPUTECPP_ROOT)
...
BACKEND_SYCLPROFILEAGENT_DIR = $(BACKEND_DIR)/SYCLProfiler
...
FRAMEWORK_LIBS = -lCXLOSWrappers -lCXLBaseTools -lCXLOSAPIWrappers
...
#++KB: LPGPU2
ARMV7A_OVERRIDES = "PLATFORM_DEFINES = -DARCH_ARM -DGDT_PLATFORM_SUFFIX=\\\"32\\\"" "CODEXL_OUTPUT_DIR = Output_armv7a" "PLATFORM_DIR = armv7a" "HSA_PLATFORM_DIR = armv7a" "HSA_PLATFORM_SUFFIX =" "HSA_PLATFORM_SUFFIX_COMPILER_LIB ="
#--KB: LPGPU2
#++AT:LPGPU2
AARCH64_OVERRIDES = "PLATFORM_DEFINES = -DARCH_AARCH64 -DGDT_PLATFORM_SUFFIX=\\\"64\\\"" "CODEXL_OUTPUT_DIR = Output_aarch64" "PLATFORM_DIR = aarch64" "HSA_PLATFORM_DIR = aarch64" "HSA_PLATFORM_SUFFIX =" "HSA_PLATFORM_SUFFIX_COMPILER_LIB ="
#--AT:LPGPU2
...
#++KB: LPGPU2
BUILD_ARMV7A_OVERRIDES = "TARGET_SUFFIX =" "AMD_LIB_PATH = Bin/Linx86/" "AMD_LIB_SUFFIX =" $(ARMV7A_OVERRIDES)
#--KB: LPGPU2
#++AT:LPGPU2
BUILD_AARCH64_OVERRIDES = "TARGET_SUFFIX =" "AMD_LIB_PATH = Bin/Linx86/" "AMD_LIB_SUFFIX =" $(AARCH64_OVERRIDES)
#--AT:LPGPU2
...
#++KB: LPGPU2
BUILD_DEBUG_ARMV7A_OVERRIDES = "TARGET_SUFFIX = -d" "AMD_LIB_PATH = Bin/Linx86/" "AMD_LIB_SUFFIX =" $(DEBUG_OVERRIDES) $(ARMV7A_OVERRIDES)
#--KB: LPGPU2
#++AT:LPGPU2
BUILD_DEBUG_AARCH64_OVERRIDES = "TARGET_SUFFIX = -d" "AMD_LIB_PATH = Bin/Linx86/" "AMD_LIB_SUFFIX =" $(DEBUG_OVERRIDES) $(AARCH64_OVERRIDES)
#--AT:LPGPU2
