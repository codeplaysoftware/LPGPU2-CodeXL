...
public class ProfilingNativeActivity extends ShimActivity
        implements Choreographer.FrameCallback{

    static {
        // Load native library to invoke chreographerCallback().
       System.loadLibrary("ProfilingNativeActivity");
    }
    ...
    ProfilingNativeActivity _activity;
    ...
    public void updateFPS(final float fFPS)
    {
        ...
        this.runOnUiThread(new Runnable()  {
            @Override
            public void run()  {
                _label.setText(String.format("%3.2f FPS (equiv)", fFPS));
            }});
    }
