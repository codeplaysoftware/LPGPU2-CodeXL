...
public class LPGPU2RMessengerInterface {
    ...
    LPGPU2RMessengerInterface(ShimActivity act){
        ...
        Log.i("ShimActivity", "DPTAT - Starting Thread....");
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
	    ...
	    // Enable the Capture, now the connection has been made.
            ...
            Log.i("ShimActivity", "DPTAT - Service Connected....");
        }
        ...
        public void onServiceDisconnected(ComponentName name) {
            mService = null;
            mBound = false;
            Log.i("ShimActivity", "DPTAT - Service Disconnected....");
        }
    };
    ...
    boolean Connect() {
        ...
        try {
            ...
            Log.i("ShimActivity", "DPTAT - Service Connected....Connect called");
    ...
    boolean Disconnect() {
        ...
        if ( mBound ){
            ...
            mBound = false;
            Log.i("ShimActivity", "DPTAT - Service Connected....Disconnect called");
        }
    ...
    boolean SendData(byte[] data, int dataLen, int msgType) {
        boolean rv = false;
        Log.i("ShimActivity", "DPTAT - SendData");
        ...
        if ( mBound ){
            ...
            try {
                Log.i("ShimActivity", "DPTAT - SendData - Sending packet");
    ...
    private class DispatchPacketsToAgentThread extends Thread {
        ...
        @Override
        public void run() {
            Log.i("ShimActivity", "DPTAT - Alive");
            while (true) {
                if ( ! theActivity.packetFIFO.isEmpty() ){
                    try {
                        Log.i("ShimActivity", "DPTAT - Have Data waiting for transmission");
                        int counter = 0;
                    ...
                    try {
                        Log.i("ShimActivity", "DPTAT - Sleeping");
