...
import static Package_Name.LPGPU2RMessengerInterface.LOGGING_ENABLED;

// Replace NativeActivity with whatever your MainActivity extends,
// and in your MainActivity, extend ShimActivity instead.

public class ShimActivity extends Activity_Name {
    String shimPath = "libGles2Shim.so";
    public static final String LPGPU2_CLIENT_STOP_COLLECTION = "Package_Name.LPGPU2_CLIENT_STOP_COLLECTION";
