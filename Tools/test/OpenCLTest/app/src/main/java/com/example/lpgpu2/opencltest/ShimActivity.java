...
import static com.example.lpgpu2.opencltest.LPGPU2RMessengerInterface.LOGGING_ENABLED;

// Replace NativeActivity with whatever your MainActivity extends,
// and in your MainActivity, extend ShimActivity instead.

public class ShimActivity extends AppCompatActivity {
    String shimPath = "libGles2Shim.so";
    public static final String LPGPU2_CLIENT_STOP_COLLECTION = "com.example.lpgpu2.opencltest.LPGPU2_CLIENT_STOP_COLLECTION";
